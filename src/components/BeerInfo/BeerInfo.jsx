    ...
    <div className="beer-page">
      ...
      <div className="beer-info">
        ...
        <div className="beer-info__column">
          ...
          <p>
            <b>Brewed in:</b> {singleBeer.first_brewed}
          </p>
          <p>
            <b>Yeast:</b> {singleBeer.ingredients.yeast}
          </p>
          <p className="beer-info__description">
            <em>{singleBeer.description}</em>
          </p>
          ...
          <p>
            <b>Tips:</b> {singleBeer.brewers_tips}
          </p>
        </div>
      </div>
    </div>
